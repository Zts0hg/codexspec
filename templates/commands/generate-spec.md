---
description: Compile confirmed requirements into a traceable spec.md
...
Read `.codexspec/config.yml`. Use `language.output` for all interaction and generated content; default to English.
