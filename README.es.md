...
| `--auto-distill`           | Alternar/establecer `workflow.auto_distill` (activado por defecto; sin valor alterna; o on/off) |
...
| `/codexspec:review-design` | Revisar el diseño (auto o manual) |
...
| `/codexspec:reverse-spec`    | Derivar spec/design a partir de código existente y conciliar el código con la línea base confirmada (solo informa, no modifica) |
...
| `/codexspec:release-notes` | Generar notas de versión desde el historial de git (mantener CHANGELOG.md + cuerpo)|
...
| Comando analyze         | Sí                         | Con corrección automática, basado en severidad, consciente de la constitución |
