---
name: "source-command-codexspec-generate-spec"
description: "需求明确后生成 spec.md 文档"
---

# source-command-codexspec-generate-spec

Use this skill when the user asks to run the migrated source command `codexspec-generate-spec`.
