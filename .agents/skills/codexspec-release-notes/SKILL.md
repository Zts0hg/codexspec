...
```
the text after the $codexspec:release-notes skill mention
```
...
Parse `the text after the $codexspec:release-notes skill mention` for the following optional parameters:
