...
│         │                                                                │
│         ▼                                                                │
│  2. Specify  ───────►  要件を明確化し requirements.md に保存              │
│         │                                                                │
│         ▼                                                                │
...
| 2 | `/codexspec:specify` | 要件を明確化・確認し requirements.md に保存 |
| 3 | `/codexspec:generate-spec` | 確認済み requirements.md から spec.md を作成 (★ 自動レビュー) |
...
| **出力** | requirements.md を作成または更新 | spec.mdを更新 |

`requirements.md` は仕様生成の権威ある入力です。明示的な機能パスを優先し、指定がなければ現在の timestamp 機能ブランチを使用します。
