...
│         │                                                                │
│         ▼                                                                │
│  2. Specify  ───────►  요구사항을 명확화하고 requirements.md에 저장         │
│         │                                                                │
│         ▼                                                                │
...
| 2 | `/codexspec:specify` | 요구사항을 명확화하고 확인하여 requirements.md에 저장 |
| 3 | `/codexspec:generate-spec` | 확인된 requirements.md에서 spec.md 생성 (★ 자동 검토) |
...
| **출력** | requirements.md 생성 또는 업데이트 | spec.md 업데이트 |

`requirements.md`는 명세 생성의 권위 있는 입력입니다. 명시적 기능 경로가 우선하며, 없으면 현재 timestamp 기능 브랜치를 사용합니다.
