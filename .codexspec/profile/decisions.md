...
- evidence.state: decided and implemented at feature 2026-0812-14054p; distill.md record-format updated; existing records on both branches migrated to the full-id scheme. Mirrors the spec-dir timestamp+random naming that already prevents parallel-branch collisions.
