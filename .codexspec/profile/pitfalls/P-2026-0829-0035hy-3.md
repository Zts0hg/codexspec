...
- evidence.facts: A clean multi-surface case evaluated as passed with empty producer, propagation, consumer, and scenario arrays as long as two entry-surface strings were present. The early-finding and incomplete-coverage cases likewise accepted one arbitrary terminal partition or an unrelated blocking gap. Field-specific trace terms, distinct scope matching, grouped finding identities, and premise-specific gap terms rejected the hollow results and accepted complete examples.
- evidence.state: observed and outcome-verified at feature 2026-0829-0035hy-review-code-systematic-coverage, commit dffcabe; applicable to future evaluation corpus changes.
