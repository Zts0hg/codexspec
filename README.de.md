...
| `--auto-distill`          | `workflow.auto_distill` umschalten/setzen (standardmäßig an; ohne Wert = umschalten; oder on/off) |
...
| Analyze-Befehl       | Ja                      | Automatische Behebung, schweregradbasiert, verfassungsbewusst |
